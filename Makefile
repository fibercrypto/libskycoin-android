...
build-swig:
	...
	mkdir -p ./lib/skycoin
	swig -android -oldvarnames -v -namespace  skycoin -Iswig/include -I$(INCLUDE_DIR) -outdir lib/skycoin -o lib/skycoin/skycoin_wrap.c $(LIBSWIG_DIR)/skycoin.i
	
build-libskycoin-android:
	gcc -c -fpic -Ilib/swig/include -I$(INCLUDE_DIR) lib/skycoin/skycoin_wrap.c
